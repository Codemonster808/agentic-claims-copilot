...
def _send_to_dlq(claim_id: str, failure_type: str, detail: str) -> None:
    ...
    src/orchestration/lambdas/send_to_dlq.py) — called directly from Python here
    ...
    sqs.send_message(
        ...
        MessageBody=json.dumps(
            {"claim_id": claim_id, "failure_type": failure_type, "reason": detail}
        ),
    )
...
def run_agentic_loop(
    claim_id: str, question: str, token_budget: int = DEFAULT_TOKEN_BUDGET
) -> dict:
    """
